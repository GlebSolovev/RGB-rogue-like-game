...
class OverloadableFactory constructor(
    ...
    private val customColorInverterSpawnCount: Int? = null
) : LevelContentFactory() {
    ...
    override val colorInverterSpawnCount: Int by customColorInverterSpawnCount orElse {
        factory.colorInverterSpawnCount
    }
}
